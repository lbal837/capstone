...
def lambda_handler(event, context):
    ...
    try:
        ...
        return {"statusCode": 200, "message": "Subscribed to patient with ID: {}".format(patient_id)}
    except Exception as e:
        return {"statusCode": 500, "message": "Failed to subscribe to patient: {}".format(str(e))}
